...
import { useDeleteVideoMutation } from "../../features/getVideos/getVideosApi";
  ...
  return (
    <>
      <tr>
        ...
        <td className="table-td">{truncate(video.description, 55)}</td>
        <td className="table-td flex gap-x-2">
          ...
          <svg
            ...
            onClick={() => navigate(`/admin/editVideo/${video.id}`)}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
